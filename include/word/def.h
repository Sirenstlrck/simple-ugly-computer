...
#define ASSERT_WORD_BOUNDS(WORD) {assert(WORD >= MIN_WORD_RAW && WORD <= MAX_WORD_RAW);}
#define ASSERT_2WORDS_BOUNDS(word1, word2) {ASSERT_WORD_BOUNDS(word1) ASSERT_WORD_BOUNDS(word2)}
